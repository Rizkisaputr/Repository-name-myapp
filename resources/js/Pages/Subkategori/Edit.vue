...
const form = useForm({
    kategori_id: props.subkategori.kategori_id ?? props.kategori_id ?? "",
    nama_subkategori: props.subkategori.nama_subkategori ?? "",
    deskripsi: props.subkategori.deskripsi ?? "",
    is_active: Boolean(props.subkategori.is_active),
});

const submit = () => {
    form.put(`/subkategori/${props.subkategori.id}`);
};
</script>
...
<template>
    <div class="min-h-screen bg-slate-100 p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Edit Subkategori</h1>
            <p class="text-sm text-slate-500">
                Perbarui data subkategori latihan soal.
            </p>
        </div>
        ...
        >
            <form @submit.prevent="submit" class="space-y-5">
                <!-- Kategori default dari data subkategori -->
                ...
                <!-- Kalau tidak ada selectedKategori, baru tampilkan select -->
                <div v-else>
                    <label
                        class="mb-1 block text-sm font-semibold text-slate-700"
                    >
