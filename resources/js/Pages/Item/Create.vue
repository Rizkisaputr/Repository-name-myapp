...
<template>
    <div class="min-h-screen bg-slate-100 p-6">
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-slate-800">Tambah Item</h1>
            <p class="text-sm text-slate-500">
                Tambahkan item paket latihan soal.
            </p>
        </div>
            ...
            <form @submit.prevent="submit" class="space-y-5">
                <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                    ...
                    <div>
                        ...
                        <div
                            v-if="form.errors.subkategori_id"
                            class="mt-1 text-sm text-red-600"
                        >
                            {{ form.errors.subkategori_id }}
                        </div>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <input
                        ...
                        type="text"
                        class="w-full rounded-lg border border-slate-300 px-4 py-2"
                        placeholder="Contoh: Paket CPNS Dasar"
                    />
                    <div
                        v-if="form.errors.nama_item"
                        class="mt-1 text-sm text-red-600"
                    >
